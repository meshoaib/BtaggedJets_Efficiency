...
# input file
inputFile = TFile.Open('MiniEvents.root')

# get 2D b-tag discriminator vs jet pT histograms
discrVsPt_b    = inputFile.Get('demo/' + bTagger + '_b')
discrVsPt_c    = inputFile.Get('demo/' + bTagger + '_c')
discrVsPt_udsg = inputFile.Get('demo/' + bTagger + '_udsg')
