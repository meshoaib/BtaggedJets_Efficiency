...
# input files
inputFile_ttbar = TFile.Open('BtagEffiecncy_ttbar.root')
inputFile_QCD   = TFile.Open('BtagEffiecncy_QCD.root')

# get 2D b-tag discriminator vs jet pT histograms
discrVsPt_b_ttbar    = inputFile_ttbar.Get('demo/' + bTagger + '_b')
discrVsPt_udsg_ttbar = inputFile_ttbar.Get('demo/' + bTagger + '_udsg')
discrVsPt_b_QCD      = inputFile_QCD.Get('demo/' + bTagger + '_b')
discrVsPt_udsg_QCD   = inputFile_QCD.Get('demo/' + bTagger + '_udsg')
